	        ...
	        while ((nextLine = br.readLine()) != null) {
	            ...
	            switch (cardType) {
	                case "SWAPPER":
	                    ...
	                    break;
	                case "ENERGYSTEAL":
	                    card = new EnergyStealCard(data[1], data[2],
	                            Integer.parseInt(data[3]), Integer.parseInt(data[4]));
	                    break;
	                case "STARTOVER":
	                    card = new StartOverCard(data[1], data[2],
	                            Integer.parseInt(data[3]), Boolean.parseBoolean(data[4]));
	                    break;
	                case "SHIELD":
	                    card = new ShieldCard(data[1], data[2], Integer.parseInt(data[3]));
	                    break;
	                case "CONFUSION":
	                    card = new ConfusionCard(data[1], data[2],
	                            Integer.parseInt(data[3]), Integer.parseInt(data[4]));
	                    break;
	                default:
